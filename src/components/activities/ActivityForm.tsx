...
const ActivityForm = ({ parcelleId, onSave, onCancel, existingActivity }: ActivityFormProps) => {
  ...
  useState(() => {
    const fetchActivityTypes = async () => {
      ...
      if (data) {
        ...
        // If we have an existing activity, set the selected type
        if (existingActivity) {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      // Prepare the details object based on activity type
  ...
  // Helper to prepare the details object based on activity type
